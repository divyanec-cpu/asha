...
- **Practice content totals 87 original questions across 6 papers (2026-08-05):** QA 43 (warm-up / coverage / challenge), VARC 16 (3 passages + verbal ability), DILR 28 (7 sets over 2 papers). Every CAT question type and 7 of 12 DILR archetypes have content. Missing archetypes are chart, scatter, data sufficiency, team selection and grid/quant hybrid — the first two lean on a graphic that text cannot honestly substitute for.
